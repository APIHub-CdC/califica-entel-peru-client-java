...
Los siguientes datos a modificar se encuentran en ***src/test/java/com/cdc/apihub/pe/calificaentel/api/EntelRuc20ApiTest.java***
```java
public void setUp() {
...
En el archivo EntelRuc20ApiTest, que se encuentra en ***src/test/java/com/cdc/apihub/pe/calificaentel/api*** se deberá modificar el siguiente fragmento de código con los datos correspondientes:
